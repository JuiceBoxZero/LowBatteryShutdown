...
# Zero is labeled according to BCM.  See https://pinout.xyz/ for more
# details on pinouts.

GPIO.setmode(GPIO.BCM)

# This is where you would change the GPIO from pin 16 to 25, if you needed
# to do so on the Juice Box Zero board itself. Default is GPIO 16. In 
# order to change the hardware, you would need to cut the GPIO 16 trace on
# the board and make a solder bridge over GPIO 25.
